...
namespace VRBuilder.Samples.HandsInteraction.Editor
{
    ...
    public sealed class SampleImportPostprocessing : AssetPostprocessor
    {
        ...
        private const string demoSceneName = "VR Builder - Core Features Demo";
        private const string sampleRootPrefix = "Assets/Samples/VR Builder";
        private const string sampleFolderName = "Demo - Core Features";
        private const string processFileName = "Demo - Core Features.json";
