...
namespace VRBuilder.Editor.Tests
{
    public class SystemClipboardTests
    {
        ...
        public void PasteWithPropertyReference()
        {
            ...
            IStep step = new BasicStepBuilder("Step")
                .AddBehavior(new ObjectReferenceBehaviorMock(Guid.NewGuid()))
                .Build();
            ...
            // Then the copy stores the same value as the original behavior.
            Assert.AreEqual(
                ((ObjectReferenceBehaviorMock)step.Data.Behaviors.Data.Behaviors.First()).Data.SingleReferenceObject.Guids.First(),
                ((ObjectReferenceBehaviorMock)copy.Data.Behaviors.Data.Behaviors.First()).Data.SingleReferenceObject.Guids.First());
        }
