...
namespace VRBuilder.Editor.DemoScene
{
    ...
    {
        private const string demoScenePath = "Assets/MindPort/VR Builder/Core/VR-Builder/Demo/Runtime/Scenes/VR Builder Demo - Core Features.unity";
        ...
        public static void LoadDemoScene()
        {
            ...
            if (File.Exists(demoProcessFilePath) == false)
            {
                ...
                FileUtil.CopyFileOrDirectory("Assets/MindPort/VR Builder/Core/VR-Builder/Demo/StreamingAssets/Processes/Demo - Core Features/Demo - Core Features.json", demoProcessFilePath);
            }
