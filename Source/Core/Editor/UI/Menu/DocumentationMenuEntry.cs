...
namespace VRBuilder.Core.Editor.Menu
{
    internal static class DocumentationMenuEntry
    {
        ...
        {
            Application.OpenURL("https://mindport-gmbh.github.io/VR-Builder-Documentation?utm_source=unity_editor&utm_medium=cpc&utm_campaign=from_unity&utm_id=from_unity");
        }
    }
}
