...
namespace VRBuilder.Editor.UI
{
    ...
    public class GuidComponentEditor : UnityEditor.Editor
    {
        ...
        {
            EditorUtils.CheckVisualTreeAssets(nameof(GuidComponentEditor), new List<VisualTreeAsset>() { manageTagsPanel, removableTag, noCustomTagsMessage, searchableList, tagListItem });
        }
        ...
        {
            IEnumerable<GuidComponent> assetsOnDisk = targets.OfType<GuidComponent>().Where(t => t.IsAssetOnDisk());
            ...
            {
                IEnumerable<GuidComponent> assetsInScene = targets.OfType<GuidComponent>().Where(t => !t.IsAssetOnDisk());
