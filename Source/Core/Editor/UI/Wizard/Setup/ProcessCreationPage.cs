...
namespace VRBuilder.Editor.UI.Wizard
{
    ...
    /// </summary>
    internal class ProcessCreationPage : WizardPage
    {
        ...
        public ProcessCreationPage() : base("Setup Process")
        {
        ...
        public override void Draw(Rect window)
        {
            ...
            if (GUILayout.Toggle(createNewProcess, "Create a new process", BuilderEditorStyles.RadioButton))
            {
            ...
            if (GUILayout.Toggle(!createNewProcess, "Scene configuration only", BuilderEditorStyles.RadioButton))
            {
