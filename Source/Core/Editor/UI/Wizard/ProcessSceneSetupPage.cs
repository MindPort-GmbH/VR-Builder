...
namespace VRBuilder.Core.Editor.UI.Wizard
{
    ...
    internal class ProcessSceneSetupPage : WizardPage
    {
        ...
        public override void Draw(Rect window)
        {
            ...
            BuilderGUILayout.DrawLink("We provide multi-user support to our Enterprise license users. Discover more here!", "https://www.mindport.co/vr-builder/pricing?utm_source=unity_wizard&utm_medium=referral&utm_campaign=from_unity&utm_id=from_unity", BuilderEditorStyles.IndentLarge);
