    ...
    internal class XRSDKSetupPage : WizardPage
    {
        ...
        public override void Draw(Rect window)
        {
            ...
            GUILayout.BeginArea(window);
            {
                ...
                BuilderGUILayout.DrawLink("Meta Quest Setup Guide", "https://www.mindport.co/vr-builder-tutorials/oculus-quest-device-setup?utm_source=unity_wizard&utm_medium=cpc&utm_campaign=from_unity&utm_id=from_unity", BuilderEditorStyles.IndentLarge);
                BuilderGUILayout.DrawLink("Pico Setup Guide", "https://www.mindport.co/vr-builder-tutorials/pico-neo-device-setup?utm_source=unity_wizard&utm_medium=cpc&utm_campaign=from_unity&utm_id=from_unity", BuilderEditorStyles.IndentLarge);
            }
            GUILayout.EndArea();
        }
