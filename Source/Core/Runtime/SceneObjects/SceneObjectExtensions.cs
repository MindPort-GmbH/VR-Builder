...
namespace VRBuilder.Core.SceneObjects
{
    ...
    {
        public static GameObject GameObject(this ISceneObject obj)
        {
            return (obj as ProcessSceneObject)?.gameObject;
        }

        // public static string ToString(this ISceneObject obj)
        // {
        //     return obj.GameObject() ? $"{obj.GameObject().name}" : "(Missing Object)";
        // }
        ...
        {
            return sceneObject == null || !sceneObject.GameObject() || processProperty == null || typeof(ISceneObjectProperty).IsAssignableFrom(processProperty) == false;
        }
        ...
        /// </summary>
        public static bool HasPersistentListener(UnityEventBase unityEvent, Object target, string methodName)
        {
        ...
        public static bool AddPersistentListener<T>(Object target, Object eventObject, UnityEvent<T> unityEvent, UnityAction<T> call)
        {
