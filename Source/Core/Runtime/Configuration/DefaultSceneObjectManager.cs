...
namespace VRBuilder.Core.Configuration
{
    ...
    public class DefaultSceneObjectManager : ISceneObjectManager
    {
        ...
        /// <inheritdoc/>
        public void InstantiatePrefab(GameObject prefab, IVector3 position, Quaternion rotation, Action<GameObject> onPrefabInstantiated = null)
        {
            GameObject instantiatedPrefab = GameObject.Instantiate(prefab, position.ToUnity(), rotation);
