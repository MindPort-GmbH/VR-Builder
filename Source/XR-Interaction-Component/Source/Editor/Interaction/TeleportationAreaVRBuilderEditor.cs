...
namespace VRBuilder.Editor.XRInteraction
{
    ...
    public class TeleportationAreaVRBuilderEditor : TeleportationAreaEditor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (GUILayout.Button("Configure teleportation area for VR Builder"))
            {
                foreach (UnityEngine.Object targetObject in serializedObject.targetObjects)
                {
                    ...
                    {
                        ConfigureTeleportationArea(teleportationArea);
                    }
                }
            }
        }

        private void ConfigureTeleportationArea(TeleportationAreaVRBuilder teleportationArea)
        {
