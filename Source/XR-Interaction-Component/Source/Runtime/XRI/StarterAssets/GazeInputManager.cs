...
namespace VRBuilder.XRInteraction.XRI.StarterAssets
{
    ...
    public class GazeInputManager : MonoBehaviour
    {
        ...
        void OnDeviceChange(InputSystem.InputDevice device, InputSystem.InputDeviceChange change)
        {
            if (m_EyeTrackingDeviceFound || change != InputSystem.InputDeviceChange.Added)
                return;
