...
namespace VRBuilder.Core.Behaviors
{
    ...
    public class MoveObjectBehaviorV2 : Behavior<MoveObjectBehaviorV2.EntityData>
    {
        /// <summary>
        ...
        public MoveObjectBehaviorV2() : this(Guid.Empty, Guid.Empty, 0f)
        {
        }

        public MoveObjectBehaviorV2(ISceneObject target, ISceneObject positionProvider, float duration) : this(ProcessReferenceUtils.GetUniqueIdFrom(target), ProcessReferenceUtils.GetUniqueIdFrom(positionProvider), duration)
        {
        }

        public MoveObjectBehaviorV2(Guid targetId, Guid positionProviderId, float duration)
        {
            Data.Target = new SingleSceneObjectReference(targetId);
            Data.PositionProvider = new SingleSceneObjectReference(positionProviderId);
